...
public class Student extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Stud studLogin=new Stud(this);
        ...
        btnlogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    studLogin.execute(type, name, pass);
                    //  Intent intent=new Intent(Login.this,Dashboard.class);
                }
                catch (Exception nm)
                {
        ...
        buttonforgetpass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Student.this,Forgetpass.class));
            }
        });
    }
...
class Stud extends AsyncTask<String,Void,String> {
    ...
    protected String doInBackground(String... params) {
        ...
        String login_url = "https://www.nextsolutions.in/schoolsnext/Demo/Login/student_login.php\n" +
                "\n";
