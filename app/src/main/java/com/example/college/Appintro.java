...
public class Appintro extends AppCompatActivity implements View.OnClickListener {
    ...
    int [] layouts = {R.layout.first_slide,R.layout.second_slide,R.layout.third_slide,R.layout.four_slide,R.layout.five_slide};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createDots(0);
        skip=(Button)findViewById(R.id.btnskp);
